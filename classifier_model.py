...
from transformers import AutoConfig, RobertaModel, XLMRobertaXLModel
...
class MyClassifier(nn.Module):
    def __init__(
        ...
        model_class = XLMRobertaXLModel if "xlm" in model_name_or_path else RobertaModel
        # model_class = XLMRobertaXLModel
